...
/* automatically generated by rust-bindgen 0.64.1 */
...
pub const KVM_X86_SNP_VM: u32 = 3;
pub const TDX_CAP_GPAW_48: u32 = 1;
pub const TDX_CAP_GPAW_52: u32 = 2;
pub const KVM_TDX_MEASURE_MEMORY_REGION: u32 = 1;
...
pub const KVM_CAP_MEMORY_ATTRIBUTES: u32 = 500;
pub const KVM_CAP_USER_MEMORY2: u32 = 750;
pub const KVM_CAP_VM_TYPES: u32 = 1000;
...
pub const KVM_GUEST_MEMFD_ALLOW_HUGEPAGE: u32 = 1;
...
pub const kvm_tdx_cmd_id_KVM_TDX_CMD_NR_MAX: kvm_tdx_cmd_id = 5;
...
#[test]
fn bindgen_test_layout_kvm_tdx_cmd() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_cmd> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_cmd>(),
        24usize,
        concat!("Size of: ", stringify!(kvm_tdx_cmd))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_cmd>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_tdx_cmd))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).id) as usize - ptr as usize },
        0usize,
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq)]
pub struct kvm_tdx_cpuid_config {
    pub leaf: __u32,
    pub sub_leaf: __u32,
    pub eax: __u32,
    pub ebx: __u32,
...
#[test]
fn bindgen_test_layout_kvm_tdx_cpuid_config() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_cpuid_config> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_cpuid_config>(),
        24usize,
        concat!("Size of: ", stringify!(kvm_tdx_cpuid_config))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_cpuid_config>(),
        4usize,
        concat!("Alignment of ", stringify!(kvm_tdx_cpuid_config))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_cpuid_config),
            "::",
            stringify!(leaf)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sub_leaf) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_cpuid_config),
...
pub struct kvm_tdx_capabilities {
    pub attrs_fixed0: __u64,
    pub attrs_fixed1: __u64,
    pub xfam_fixed0: __u64,
    pub xfam_fixed1: __u64,
    pub supported_gpaw: __u32,
    pub padding: __u32,
    pub reserved: [__u64; 251usize],
    pub nr_cpuid_configs: __u32,
    pub cpuid_configs: __IncompleteArrayField<kvm_tdx_cpuid_config>,
}
#[test]
fn bindgen_test_layout_kvm_tdx_capabilities() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_capabilities> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_capabilities>(),
        2056usize,
        concat!("Size of: ", stringify!(kvm_tdx_capabilities))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_capabilities>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_tdx_capabilities))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).attrs_fixed0) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(attrs_fixed0)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).attrs_fixed1) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(attrs_fixed1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).xfam_fixed0) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(xfam_fixed0)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).xfam_fixed1) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(xfam_fixed1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).supported_gpaw) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(supported_gpaw)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).padding) as usize - ptr as usize },
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nr_cpuid_configs) as usize - ptr as usize },
        2048usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(nr_cpuid_configs)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).cpuid_configs) as usize - ptr as usize },
        2052usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_capabilities),
            "::",
            stringify!(cpuid_configs)
        )
    );
}
...
pub struct kvm_tdx_init_vm {
    ...
    pub reserved: [__u64; 1004usize],
    pub cpuid: kvm_cpuid2,
}
#[test]
fn bindgen_test_layout_kvm_tdx_init_vm() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_init_vm> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_init_vm>(),
        8192usize,
        concat!("Size of: ", stringify!(kvm_tdx_init_vm))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_init_vm>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_tdx_init_vm))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_init_vm),
            "::",
            stringify!(attributes)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mrconfigid) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_init_vm),
            "::",
            stringify!(mrconfigid)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mrowner) as usize - ptr as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_init_vm),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mrownerconfig) as usize - ptr as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_init_vm),
            "::",
            stringify!(mrownerconfig)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).reserved) as usize - ptr as usize },
...
impl Default for kvm_tdx_init_vm {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[test]
fn bindgen_test_layout_kvm_tdx_init_mem_region() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_init_mem_region> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_init_mem_region>(),
        24usize,
        concat!("Size of: ", stringify!(kvm_tdx_init_mem_region))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_init_mem_region>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_tdx_init_mem_region))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).source_addr) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_init_mem_region),
            "::",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).nr_pages) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_init_mem_region),
...
#[test]
fn bindgen_test_layout_kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1>(),
        8usize,
        concat!(
            "Size of: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_rcx) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).reg_mask) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1),
...
impl Default for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl ::std::fmt::Debug for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_1 {{ union }}"
        )
    }
}
#[repr(C)]
...
#[test]
fn bindgen_test_layout_kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2>(),
        8usize,
        concat!(
            "Size of: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r10) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2),
...
impl Default for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl ::std::fmt::Debug for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_2 {{ union }}"
        )
    }
}
#[repr(C)]
...
#[test]
fn bindgen_test_layout_kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3>(),
        8usize,
        concat!(
            "Size of: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r11) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).subfunction) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3),
            "::",
            stringify!(subfunction)
        )
    );
}
impl Default for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl ::std::fmt::Debug for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_3 {{ union }}"
        )
    }
}
#[repr(C)]
...
#[test]
fn bindgen_test_layout_kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4>(),
        8usize,
        concat!(
            "Size of: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r10) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4),
...
impl Default for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl ::std::fmt::Debug for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall__bindgen_ty_4 {{ union }}"
        )
    }
}
#[test]
fn bindgen_test_layout_kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall>(),
        200usize,
        concat!(
            "Size of: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall)
        )
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall)
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r12) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r13) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r14) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r15) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_rbx) as usize - ptr as usize },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_rdi) as usize - ptr as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_rsi) as usize - ptr as usize },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r8) as usize - ptr as usize },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_r9) as usize - ptr as usize },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).in_rdx) as usize - ptr as usize },
        96usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r11) as usize - ptr as usize },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r12) as usize - ptr as usize },
        120usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r13) as usize - ptr as usize },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r14) as usize - ptr as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r15) as usize - ptr as usize },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_rbx) as usize - ptr as usize },
        152usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_rdi) as usize - ptr as usize },
        160usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_rsi) as usize - ptr as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r8) as usize - ptr as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_r9) as usize - ptr as usize },
        184usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).out_rdx) as usize - ptr as usize },
        192usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall),
...
impl Default for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl ::std::fmt::Debug for kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write ! (f , "kvm_tdx_exit__bindgen_ty_1_kvm_tdx_vmcall {{ __bindgen_anon_1: {:?}, __bindgen_anon_2: {:?}, __bindgen_anon_3: {:?}, in_r12: {:?}, in_r13: {:?}, in_r14: {:?}, in_r15: {:?}, in_rbx: {:?}, in_rdi: {:?}, in_rsi: {:?}, in_r8: {:?}, in_r9: {:?}, in_rdx: {:?}, __bindgen_anon_4: {:?}, out_r11: {:?}, out_r12: {:?}, out_r13: {:?}, out_r14: {:?}, out_r15: {:?}, out_rbx: {:?}, out_rdi: {:?}, out_rsi: {:?}, out_r8: {:?}, out_r9: {:?}, out_rdx: {:?} }}" , self . __bindgen_anon_1 , self . __bindgen_anon_2 , self . __bindgen_anon_3 , self . in_r12 , self . in_r13 , self . in_r14 , self . in_r15 , self . in_rbx , self . in_rdi , self . in_rsi , self . in_r8 , self . in_r9 , self . in_rdx , self . __bindgen_anon_4 , self . out_r11 , self . out_r12 , self . out_r13 , self . out_r14 , self . out_r15 , self . out_rbx , self . out_rdi , self . out_rsi , self . out_r8 , self . out_r9 , self . out_rdx)
    }
}
#[test]
fn bindgen_test_layout_kvm_tdx_exit__bindgen_ty_1() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit__bindgen_ty_1> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit__bindgen_ty_1>(),
        200usize,
        concat!("Size of: ", stringify!(kvm_tdx_exit__bindgen_ty_1))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit__bindgen_ty_1>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_tdx_exit__bindgen_ty_1))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).vmcall) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_tdx_exit__bindgen_ty_1),
            "::",
            stringify!(vmcall)
        )
    );
}
impl Default for kvm_tdx_exit__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl ::std::fmt::Debug for kvm_tdx_exit__bindgen_ty_1 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(f, "kvm_tdx_exit__bindgen_ty_1 {{ union }}")
    }
}
#[test]
fn bindgen_test_layout_kvm_tdx_exit() {
    const UNINIT: ::std::mem::MaybeUninit<kvm_tdx_exit> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<kvm_tdx_exit>(),
        208usize,
        concat!("Size of: ", stringify!(kvm_tdx_exit))
    );
    assert_eq!(
        ::std::mem::align_of::<kvm_tdx_exit>(),
        8usize,
        concat!("Alignment of ", stringify!(kvm_tdx_exit))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).type_) as usize - ptr as usize },
        0usize,
...
impl ::std::fmt::Debug for kvm_tdx_exit {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "kvm_tdx_exit {{ type: {:?}, pad: {:?}, u: {:?} }}",
...
fn bindgen_test_layout_kvm_run__bindgen_ty_1() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).tdx) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(kvm_run__bindgen_ty_1),
